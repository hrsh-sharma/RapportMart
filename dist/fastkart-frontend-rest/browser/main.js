...
NgxsStoragePlugin.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({
...
NgxsStoragePluginModule.\u0275mod = /* @__PURE__ */ \u0275\u0275defineNgModule({
  type: NgxsStoragePluginModule
});
NgxsStoragePluginModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({});
(() => {
...
LoadingBarComponent.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({
...
LoadingBarModule.\u0275mod = /* @__PURE__ */ \u0275\u0275defineNgModule({
  type: LoadingBarModule
});
LoadingBarModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({
...
LoadingBarRouterModule.\u0275mod = /* @__PURE__ */ \u0275\u0275defineNgModule({
  type: LoadingBarRouterModule
});
LoadingBarRouterModule.\u0275inj = /* @__PURE__ */ \u0275\u0275defineInjector({
...
var AuthInterceptor = class _AuthInterceptor {
  constructor(store, router, ngZone, notificationService) {
    this.store = store;
    this.router = router;
    this.ngZone = ngZone;
  ...
  static {
    this.\u0275fac = function AuthInterceptor_Factory(t) {
      return new (t || _AuthInterceptor)(\u0275\u0275inject(Store), \u0275\u0275inject(Router), \u0275\u0275inject(NgZone), \u0275\u0275inject(NotificationService));
    };
  }
  static {
...
], AuthInterceptor.prototype, "setting$", void 0);
...
var LoaderInterceptor = class _LoaderInterceptor {
  ...
  static {
    this.\u0275fac = function LoaderInterceptor_Factory(t) {
      return new (t || _LoaderInterceptor)(\u0275\u0275inject(Store));
    };
  }
  static {
...
var ErrorService = class _ErrorService {
  ...
  getClientErrorMessage(error) {
    return navigator.onLine ? error.message ? error.message : "Something Went Wrong" : "No Internet Connection";
  }
  ...
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _ErrorService, factory: _ErrorService.\u0275fac, providedIn: "root" });
  }
};
...
var GlobalErrorHandler = class _GlobalErrorHandler {
  ...
  static {
    this.\u0275fac = function GlobalErrorHandler_Factory(t) {
      return new (t || _GlobalErrorHandler)(\u0275\u0275inject(Injector));
    };
  }
  static {
...
var content = [
  {
    path: "",
    loadChildren: () => import("./chunk-XZVJNQKD.js").then((m) => m.ThemesModule),
    title: "GROFAB Premium Mens and Womens Fashion Online"
  },
  {
    path: "privacy-policy",
    loadChildren: () => import("./chunk-FZVIUJOR.js").then((m) => m.PrivacyPolicyModule),
    title: "Privacy Policy \u2013 How We Use Your Data | GROFAB"
  },
  {
    path: "return-policy",
    loadChildren: () => import("./chunk-LD76IDQL.js").then((m) => m.ReturnExchangeModule),
    title: "Easy 7-Day Return Policy \u2013 Shop Risk-Free | GROFAB"
  },
  {
    path: "refund-and-cancellation",
    loadChildren: () => import("./chunk-BTL6GO5Y.js").then((m) => m.RefundAndCancellationModule),
    title: "Refund & Cancellation Policy \u2013 Smooth Shopping | GROFAB"
  },
  {
    path: "Contact-Us",
    loadChildren: () => import("./chunk-WDUZ7LTG.js").then((m) => m.ContactUsModule),
    title: "Contact GROFAB \u2013 We\u2019re Here to Help You 24/7"
  },
  {
    path: "term-condition",
    loadChildren: () => import("./chunk-VUQUA32W.js").then((m) => m.TermConditionModule),
    title: "Terms & Conditions \u2013 Rules of Using GROFAB"
  },
  {
    path: "shipping-policy",
    loadChildren: () => import("./chunk-RADICQFS.js").then((m) => m.ShippingDelevaryModule),
    title: "Shipping & Delivery Information \u2013 Fast & Safe | GROFAB"
  },
  {
    path: "auth",
    loadChildren: () => import("./chunk-WKI7WQHN.js").then((m) => m.AuthModule),
    canActivateChild: [AuthGuard],
    title: "Login or Register Your GROFAB Account Securely"
  },
  {
    path: "account",
    loadChildren: () => import("./chunk-NDLDYK7A.js").then((m) => m.AccountModule),
    canActivate: [AuthGuard],
    title: "Manage Your Orders & Profile | GROFAB Account"
  },
  {
    path: "",
    loadChildren: () => import("./chunk-DLYTVSMW.js").then((m) => m.ShopModule),
    title: "Browse Fashion Clothing Categories \u2013 Shop Online | GROFAB"
  },
  {
    path: "",
    loadChildren: () => import("./chunk-Z7T5ZNR6.js").then((m) => m.BlogModule),
    title: "GROFAB Blog \u2013 Latest Fashion News, Tips & Trends"
  },
  {
    path: "",
    loadChildren: () => import("./chunk-TR2C7XNY.js").then((m) => m.PagesModule),
    title: "Explore GROFAB Info Pages \u2013 Learn More About Us"
  },
  {
    path: "**",
    pathMatch: "full",
    component: Error404Component,
    title: "404 Error \u2013 Page Not Found | GROFAB Fashion Store"
  }
];

// src/app/layout/layout.component.ts
function LayoutComponent_app_loader_1_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-loader");
  }
}
function LayoutComponent_app_sticky_cart_6_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-sticky-cart");
  }
}
function LayoutComponent_app_back_to_top_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-back-to-top");
  }
}
function LayoutComponent_app_newsletter_modal_12_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-newsletter-modal");
  }
}
function LayoutComponent_app_exit_modal_14_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-exit-modal", 6);
  }
}
var LayoutComponent = class _LayoutComponent {
  constructor(store, route, router, themeOptionService) {
    ...
    const getBlog$ = currentUrl === "/" || currentUrl.startsWith("/?") || currentUrl === "/home" ? null : this.store.dispatch(new GetBlogs({ status: 1, paginate: 10 }));
  ...
  setLogo() {
    var headerLogo = "assets/images/repportlogo.png";
    var footerLogo = "assets/images/repportlogo.png";
    var footerClass;
    if (this.theme) {
      if (this.theme == "paris") {
        ...
        headerLogo = "assets/images/repportlogo.png";
        footerLogo = "assets/images/repportlogo.png";
        footerClass = "footer-section-2 footer-color-3";
  ...
  static {
    this.\u0275fac = function LayoutComponent_Factory(t) {
      return new (t || _LayoutComponent)(\u0275\u0275directiveInject(Store), \u0275\u0275directiveInject(ActivatedRoute), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(ThemeOptionService));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _LayoutComponent, selectors: [["app-layout"]], decls: 16, vars: 17, consts: [[1, "loader-bg", 3, "includeSpinner", "height"], [4, "ngIf"], [3, "logo"], [3, "footer"], [1, "theme-option"], ["it-modal", "", 4, "ngIf"], ["it-modal", ""]], template: function LayoutComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275element(0, "ngx-loading-bar", 0);
        \u0275\u0275template(1, LayoutComponent_app_loader_1_Template, 1, 0, "app-loader", 1);
        \u0275\u0275element(2, "app-header", 2)(3, "router-outlet")(4, "app-footer", 3)(5, "app-cart-sidebar");
        \u0275\u0275template(6, LayoutComponent_app_sticky_cart_6_Template, 1, 0, "app-sticky-cart", 1);
        \u0275\u0275pipe(7, "async");
        \u0275\u0275element(8, "app-sticky-compare");
        \u0275\u0275elementStart(9, "div", 4);
        \u0275\u0275template(10, LayoutComponent_app_back_to_top_10_Template, 1, 0, "app-back-to-top", 1);
        \u0275\u0275pipe(11, "async");
        \u0275\u0275elementEnd();
        \u0275\u0275template(12, LayoutComponent_app_newsletter_modal_12_Template, 1, 0, "app-newsletter-modal", 1);
        \u0275\u0275pipe(13, "async");
        \u0275\u0275template(14, LayoutComponent_app_exit_modal_14_Template, 1, 0, "app-exit-modal", 5);
        \u0275\u0275pipe(15, "async");
      }
      if (rf & 2) {
        let tmp_5_0;
        ...
        let tmp_7_0;
        let tmp_8_0;
        \u0275\u0275property("includeSpinner", true)("height", "3px");
        \u0275\u0275advance();
        \u0275\u0275property("ngIf", ctx.themeOptionService.preloader);
        \u0275\u0275advance();
        \u0275\u0275property("logo", ctx.setLogo().header_logo);
        \u0275\u0275advance(2);
        \u0275\u0275property("footer", ctx.setLogo().footer);
        \u0275\u0275advance(2);
        \u0275\u0275property("ngIf", ((tmp_5_0 = \u0275\u0275pipeBind1(7, 9, ctx.themeOption$)) == null ? null : tmp_5_0.general == null ? null : tmp_5_0.general.cart_style) == "cart_mini");
        \u0275\u0275advance(4);
        \u0275\u0275property("ngIf", (tmp_6_0 = \u0275\u0275pipeBind1(11, 11, ctx.themeOption$)) == null ? null : tmp_6_0.general == null ? null : tmp_6_0.general.back_to_top_enable);
        \u0275\u0275advance(2);
        \u0275\u0275property("ngIf", (tmp_7_0 = \u0275\u0275pipeBind1(13, 13, ctx.themeOption$)) == null ? null : tmp_7_0.popup == null ? null : tmp_7_0.popup.news_letter == null ? null : tmp_7_0.popup.news_letter.is_enable);
        \u0275\u0275advance(2);
        \u0275\u0275property("ngIf", ctx.exit && ((tmp_8_0 = \u0275\u0275pipeBind1(15, 15, ctx.themeOption$)) == null ? null : tmp_8_0.popup == null ? null : tmp_8_0.popup.exit == null ? null : tmp_8_0.popup.exit.is_enable));
      }
    }, dependencies: [NgIf, RouterOutlet, LoaderComponent, HeaderComponent, FooterComponent, StickyCartComponent, StickyCompareComponent, BackToTopComponent, NewsletterModalComponent, ExitModalComponent, CartSidebarComponent, LoadingBarComponent, AsyncPipe] });
  }
};
__decorate([
  Select(ThemeOptionState.themeOptions)
], LayoutComponent.prototype, "themeOption$", void 0);
__decorate([
  Select(ThemeOptionState.cookies)
], LayoutComponent.prototype, "cookies$", void 0);
__decorate([
  Select(ThemeOptionState.exit)
], LayoutComponent.prototype, "exit$", void 0);
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(LayoutComponent, { className: "LayoutComponent", filePath: "src\\app\\layout\\layout.component.ts", lineNumber: 22 });
})();

// src/app/maintenance/maintenance.component.ts
var _c0 = (a0) => ({ "background-image": a0 });
function MaintenanceComponent_app_sale_timer_17_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "app-sale-timer", 10);
    \u0275\u0275pipe(1, "async");
    \u0275\u0275pipe(2, "async");
  }
  if (rf & 2) {
    ...
    let tmp_2_0;
    const ctx_r0 = \u0275\u0275nextContext();
    \u0275\u0275property("startDate", (tmp_1_0 = \u0275\u0275pipeBind1(1, 2, ctx_r0.setting$)) == null ? null : tmp_1_0.maintenance == null ? null : tmp_1_0.maintenance.start_date)("endDate", (tmp_2_0 = \u0275\u0275pipeBind1(2, 4, ctx_r0.setting$)) == null ? null : tmp_2_0.maintenance == null ? null : tmp_2_0.maintenance.end_date);
  }
}
var MaintenanceComponent = class _MaintenanceComponent {
  ...
  static {
    this.\u0275fac = function MaintenanceComponent_Factory(t) {
      return new (t || _MaintenanceComponent)(\u0275\u0275directiveInject(Router));
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _MaintenanceComponent, selectors: [["app-maintenance"]], decls: 20, vars: 16, consts: [[1, "coming-soon-section", "pt-0", 3, "ngStyle"], [1, "bg-black"], [1, "container-fluid-lg", "w-100"], [1, "row"], [1, "col-lg-5"], [1, "col-xxl-5", "col-xl-6", "col-lg-7"], [1, "coming-box"], [1, "coming-title"], [1, "coming-text"], [3, "startDate", "endDate", 4, "ngIf"], [3, "startDate", "endDate"]], template: function MaintenanceComponent_Template(rf, ctx) {
      if (rf & 1) {
        ...
        \u0275\u0275element(5, "div", 4);
        \u0275\u0275elementStart(6, "div", 5)(7, "div", 6)(8, "div")(9, "div", 7)(10, "h2");
        \u0275\u0275text(11);
        \u0275\u0275pipe(12, "async");
        \u0275\u0275elementEnd()();
        ...
        \u0275\u0275template(17, MaintenanceComponent_app_sale_timer_17_Template, 3, 6, "app-sale-timer", 9);
        \u0275\u0275pipe(18, "async");
        \u0275\u0275pipe(19, "async");
        \u0275\u0275elementEnd()()()()()()();
      }
      if (rf & 2) {
        ...
        let tmp_2_0;
        let tmp_3_0;
        \u0275\u0275property("ngStyle", \u0275\u0275pureFunction1(14, _c0, "url(" + ((tmp_0_0 = \u0275\u0275pipeBind1(1, 4, ctx.setting$)) == null ? null : tmp_0_0.maintenance == null ? null : tmp_0_0.maintenance.maintenance_image == null ? null : tmp_0_0.maintenance.maintenance_image.original_url) + ")"));
        \u0275\u0275advance(11);
        \u0275\u0275textInterpolate((tmp_1_0 = \u0275\u0275pipeBind1(12, 6, ctx.setting$)) == null ? null : tmp_1_0.maintenance == null ? null : tmp_1_0.maintenance.title);
        \u0275\u0275advance(3);
        \u0275\u0275textInterpolate1(" ", (tmp_2_0 = \u0275\u0275pipeBind1(15, 8, ctx.setting$)) == null ? null : tmp_2_0.maintenance == null ? null : tmp_2_0.maintenance.description, " ");
        \u0275\u0275advance(3);
        \u0275\u0275property("ngIf", ((tmp_3_0 = \u0275\u0275pipeBind1(18, 10, ctx.setting$)) == null ? null : tmp_3_0.maintenance == null ? null : tmp_3_0.maintenance.start_date) && ((tmp_3_0 = \u0275\u0275pipeBind1(19, 12, ctx.setting$)) == null ? null : tmp_3_0.maintenance == null ? null : tmp_3_0.maintenance.end_date));
      }
    }, dependencies: [NgIf, NgStyle, SaleTimerComponent, AsyncPipe] });
  }
};
__decorate([
  Select(SettingState.setting)
], MaintenanceComponent.prototype, "setting$", void 0);
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(MaintenanceComponent, { className: "MaintenanceComponent", filePath: "src\\app\\maintenance\\maintenance.component.ts", lineNumber: 13 });
})();

// src/app/core/guard/scroll.guard.ts
var ScrollPositionGuard = class _ScrollPositionGuard {
  ...
  static {
    this.\u0275fac = function ScrollPositionGuard_Factory(t) {
      return new (t || _ScrollPositionGuard)(\u0275\u0275inject(ViewportScroller), \u0275\u0275inject(Router));
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _ScrollPositionGuard, factory: _ScrollPositionGuard.\u0275fac, providedIn: "root" });
  }
};
...
var AppComponent = class _AppComponent {
  constructor(document2, config, actions, router, store, seoService, translate, cartService) {
    ...
    this.themeOption$.subscribe((theme) => {
      if (theme?.general?.mode === "dark") {
        document2.getElementsByTagName("html")[0].classList.add(theme?.general && theme?.general?.mode);
      } else {
        document2.getElementsByTagName("html")[0].classList.remove("dark");
      }
      if (theme?.general?.language_direction === "rtl") {
        document2.getElementsByTagName("html")[0].setAttribute("dir", "rtl");
        document2.body.classList.add("rtl");
      } else {
        document2.getElementsByTagName("html")[0].removeAttribute("dir");
        document2.body.classList.remove("rtl");
      }
      this.favIcon = document2.querySelector("#appIcon");
      this.favIcon.href = "assets/images/favicon-grofav.png";
    });
  ...
  static {
    this.\u0275fac = function AppComponent_Factory(t) {
      return new (t || _AppComponent)(\u0275\u0275directiveInject(DOCUMENT), \u0275\u0275directiveInject(NgbRatingConfig), \u0275\u0275directiveInject(Actions), \u0275\u0275directiveInject(Router), \u0275\u0275directiveInject(Store), \u0275\u0275directiveInject(SeoService), \u0275\u0275directiveInject(TranslateService), \u0275\u0275directiveInject(CartService));
    };
  }
  static {
...
__decorate([
  Select(ThemeOptionState.themeOptions)
], AppComponent.prototype, "themeOption$", void 0);
__decorate([
  Select(SettingState.setting)
], AppComponent.prototype, "setting$", void 0);
(() => {
...
var SubscriptionService = class _SubscriptionService {
  ...
  static {
    this.\u0275fac = function SubscriptionService_Factory(t) {
      return new (t || _SubscriptionService)(\u0275\u0275inject(HttpClient));
    };
  }
  static {
...
// src/app/shared/state/subscription.state.ts
var SubscriptionState = class _SubscriptionState {
  constructor(notificationService, subscriptionService) {
    this.notificationService = notificationService;
    this.subscriptionService = subscriptionService;
  }
  create(ctx, action) {
    return this.subscriptionService.sendEmail(action.payload).pipe(tap({
      complete: () => {
  ...
  static {
    this.\u0275fac = function SubscriptionState_Factory(t) {
      return new (t || _SubscriptionState)(\u0275\u0275inject(NotificationService), \u0275\u0275inject(SubscriptionService));
    };
  }
  static {
    this.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _SubscriptionState, factory: _SubscriptionState.\u0275fac });
  }
};
__decorate([
  Action(Subscription)
], SubscriptionState.prototype, "create", null);

// src/app/app.module.ts
function HttpLoaderFactory(http) {
  return new TranslateHttpLoader(http, "./assets/i18n/", ".json");
}
function appLoadFactory(config) {
