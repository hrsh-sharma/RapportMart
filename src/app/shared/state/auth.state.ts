...
import { ForgotPassWord, Login, VerifyEmailOtp, UpdatePassword, Logout, AuthClear, Register, VerifyNumberOTP, LoginWithNumber, VerifyRegistrationOtp, SetAuthEmail } from "../action/auth.action";
...
export class AuthState {
  ...
  register(ctx: StateContext<AuthStateModel>, action: Register) {
    return this.authService.register(action.payload).pipe(
      tap({
        next: () => {
          ctx.patchState({ email: action.payload.email });
        },
        error: err => {
  ...
  @Action(SetAuthEmail)
  setAuthEmail(ctx: StateContext<AuthStateModel>, action: SetAuthEmail) {
