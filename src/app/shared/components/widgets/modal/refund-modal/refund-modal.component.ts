...
export class RefundModalComponent {
  ...
  async openModal(product: Product, order_id: number, payment_method: string = '') {
    this.product = product;
    this.isCod = payment_method?.toLowerCase() === 'cod';
    ...
    if (!this.isCod) {
      ...
      this.form.controls['payment_type'].setValue('wallet');
    }
    this.modalOpen = true;
