...
export class SearchComponent {
  ...
  constructor(private store: Store, public productService: ProductService, private route: ActivatedRoute, public router: Router, private seoService: SeoService){
    this.route.queryParams.subscribe(params => {
      ...
      this.seoService.setSEOData({
        title: searchTerm ? `Search results for "${searchTerm}" | Rapportmart` : 'Search Products | Rapportmart',
        description: `Search for premium men's and women's clothing at Rapportmart.`,
        url: 'https://rapportmart.com/search',
        canonicalUrl: 'https://rapportmart.com/search',
        type: 'website'
      });
    });
  }
